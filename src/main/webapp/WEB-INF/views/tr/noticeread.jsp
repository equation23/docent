        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="input-group searchDiv">
                    <div class="select">
                        <select class="type">
                            <option value="t" ${listDTO.type =="t"?"selected":""}>작성자</option>
                            <option value="c" ${listDTO.type =="c"?"selected":""}>제목</option>
                            <option value="w" ${listDTO.type =="w"?"selected":""}>내용</option>
                        </select>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3 content" style="clear:both;">
                    <div class="card-body">
                        <%--            <p class="card-text"><small class="text-muted">${dto.classify}</small></p>--%>
                        <div class="callout large">
                            <span style="width: 180vh; height: 100vh;white-space: pre-line">${dto.content}</span>
                        </div>
                    </div>
                </div>
            </div>
...
<form class="actionForm" action="/tr/notice" method="get">
...
<script>
    ...
    function showImg(){
        axios.get("/tr/files/${dto.bno}").then(
            res => {
                const arr = res.data
                let str= ""
                for(let i= 0;i < arr.length; i++){
                    str += `<img src='/view1?fileName=\${arr[i].link}'>`
                }
    ...
    document.querySelector(".searchBtn").addEventListener("click", (e) => {
        ...
        actionForm.setAttribute("action", "/tr/notice")
