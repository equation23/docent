    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">공지사항 입력</h1>
                <div>
                ...
                <form class="actionForm" action="/tr/register" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" aria-label="Sizing example input"
                               aria-describedby="inputGroup-sizing-default" name="dname">
                    </div>
                    <div class="input-group">
                    ...
                    <button class="btn btn-primary formBtn" style="height: 40px;width: 150px;float: right">공지 등록
                    </button>
                </form>
            </div>
            <!-- /.container-fluid -->
