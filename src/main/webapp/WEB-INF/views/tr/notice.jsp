    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid ">
                <button class="btn btn-primary" onclick="location.href='/tr/register/'"
                        style="height: 50px;width: 200px;float: right">공지 등록
                </button>
                <!-- Page Heading -->
                                ...
                                <table class="table">
                                    ...
                                    <c:forEach items="${dtoList}" var="board">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href='/tr/noticeread/${board.bno}' class="dtoLink"> <c:out
                                                        value="${board.title}"/> </a>
                                            </td>
                                            <td>${board.dname}</td>
                                            <td>${board.regdate}</td>
